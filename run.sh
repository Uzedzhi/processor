#!/bin/bash
LINUX_FLAGS="-D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat\
...
g++ -L/mnt/c/Users/Azerty/my_project/my_libs assembly/assembly.cpp helpers/helpers.cpp -Wl,-rpath=/mnt/c/Users/Azerty/my_project/my_libs/ $LINUX_FLAGS -o outputexe/asm -I/mnt/c/Users/Azerty/my_project/my_libs/ -lerror_manage
g++ -L/mnt/c/Users/Azerty/my_project/my_libs processor/processor.cpp helpers/helpers.cpp stack/stack.cpp -Wl,-rpath=/mnt/c/Users/Azerty/my_project/my_libs/ $LINUX_FLAGS -o outputexe/proc -I/mnt/c/Users/Azerty/my_project/my_libs/ -lerror_manage
